  ...
  public partial class WC
  {
    ...
    public static void Temporal(ref IEnumerable<LINAA.MeasurementsRow> meas, ref LINAA.IRequestsAveragesRow ir)
    {
      ...
      foreach (LINAA.MeasurementsRow m in meas)
      {
        ...
        double _T5 = S5 * MyMath.D(L5, dec) * MyMath.C(L5, countMin);                            //auxiliar
        ...
        foreach (LINAA.PeaksRow p in peaks) p.MD = 0;
        ...
        switch (decayMod)
        {
          ...
          case 1:
            foreach (LINAA.PeaksRow p in peaks) p.T0 = _T2;
            break;
          ...
          case 2:
            {
              ...
              a = ((L3 * _T2) - (L2 * _T3)) / l32;
              b = (n.F1 / n.F2) * _T2;
              foreach (LINAA.PeaksRow p in peaks) p.T0 = a + b;
            }
            break;
          ...
          case 3:
            {
              ...
              foreach (LINAA.PeaksRow p in peaks) p.T0 = (a + c) - b;
            }
            break;
