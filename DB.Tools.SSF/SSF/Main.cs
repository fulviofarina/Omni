...
namespace DB.Tools
{
    public partial class MatSSF : CalculateBase
    {
        ...
        public void DoChMethod(ref UnitRow UNIT)
        {
            doChMethod(ref UNIT);
        }
        ...
        public bool DoMatSSF(string lecture, ref UnitRow UNIT, bool doSSF)
        {
        ...
        protected internal int numberofSteps = 7;
        ...
        public Process runProcess(bool hide, ref string[] arrayOfUnitFiles)
        {
            ...
            try
            {
                proceso = runProcess(_startupPath, ref arrayOfUnitFiles, hide, process_Exited);
