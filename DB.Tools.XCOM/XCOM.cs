...
namespace DB.Tools
{
  public class XCOM
  {
    ...
    /// <summary>
    /// Obtains the mass attenuation coefficients for total absorbtion without coherent scattering and compton and returns a table
    /// </summary>
    ...
    /// <summary>
    /// Obtains the mass attenuation coefficients for total absorbtion without coherent scattering and compton and returns a path toRow the ascii file
    /// </summary>
    /// <param name="MatrixComposition"></param>
    /// <param name="NrOfEnergies"></param>
    /// <param name="StartEnergy"></param>
