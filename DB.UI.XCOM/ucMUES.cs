...
namespace DB.UI
{
    public partial class ucMUES : UserControl
    {
        ...
        protected internal void bindDGVColumns()
        {
        ...
        protected internal void bindPreference(IXCOMPreferences preference)
        {
        ...
        /// </summary>
        /// <param name="m"></param>
        protected internal void getDataToPlot(ref MatrixRow m)
        {
        ...
        protected internal void refreshDGV(object sender, EventArgs e)
        {
            DGV.Visible = false;
            IEnumerable<MUESColumn> cols = DGV.Columns.OfType<MUESColumn>();
            foreach (MUESColumn c in cols)
