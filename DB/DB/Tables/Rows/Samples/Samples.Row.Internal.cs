      ...
      //          pref?.CalcMass,
        ...
        //     pref?.CalcDensity,
         //   pref?.AAFillHeight
                ...
                calRad = (bool)pref?.AARadius; //  pref.AARadius;
                calculateDensity = (bool)pref?.CalcDensity;// pref.CalcDensity;
                calFh = (bool)pref?.AAFillHeight;// pref.AAFillHeight;
            ...
            internal void Checking(DataColumnChangeEventArgs e)
            {
                ...
                if (change)
                {
                    UnitRow?.ValueChanged(change);
                    this.tableSubSamples.InvokeCalculations?.Invoke(null, EventArgs.Empty);
                }
            }
