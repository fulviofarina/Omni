...
namespace k0X
{
    ...
    public class Watch : IWatch
    {
        ...
        {
            if ((Interface.IReport.IsSpectraPathOk))
            {
        ...
        private void CheckAFeed(ref string subject, ref string email, ref string summary, ref DateTime received)
        {
            ...
            {
                if (Interface.IReport.IsSpectraPathOk) IWatchers.AddOrFixSchedule(subject, email, summary);
            }
            else if (!subject.Contains(k0X.Properties.CmdRes.REBOOT))
            {
                ...
                {
                    if (Interface.IReport.IsSpectraPathOk) IWatchers.ExecuteCmd(email, cmd, det);
                }
            }
