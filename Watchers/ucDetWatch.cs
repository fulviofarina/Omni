    ...
    public partial class ucDetWatch : UserControl
    {
        ...
        protected void CalculateSolCoin(HashSet<double> Fullenergylist)
        {
            try
            {
                ...
                if (EC.IsNuDelDetch(this.currentMeas)) return;
                if (EC.IsNuDelDetch(this.currentSample)) return;
