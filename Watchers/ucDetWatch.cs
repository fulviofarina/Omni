...
namespace k0X
{
    public partial class ucDetWatch : UserControl
    {
        ...
        public ucDetWatch(ref LINAA set)
        {
            InitializeComponent();
            this.SuspendLayout();
            ...
            if (this.Linaa.CurrentPref != null)
            {
                abox.Text = this.Linaa.CurrentPref.windowA.ToString();
                bbox.Text = this.Linaa.CurrentPref.windowB.ToString();
                srvBox.Text = this.Linaa.CurrentPref.SpectraSvr;
                this.specPathbox.Text = this.Linaa.CurrentPref.Spectra;
            }
