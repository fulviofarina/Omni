...
namespace k0X
{
    public partial class ucToDoData : UserControl
    {
        ...
        public ucToDoData(ref Interface set)
        {
        ...
        private void GetLastData()
        {
            try
            {
                ...
                if (Interface.IPreferences.CurrentPref.IsLastToDoNull())
                {
                ...
                {
                    string[] lastOne = Interface.IPreferences.CurrentPref.LastToDo.Split(c);
