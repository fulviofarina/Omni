...
namespace k0X
{
    public partial class ucSamples
    {
        public ucSamples(ref Interface set)
        {
            ...
            this.pTable = LIMS.UserControls.OfType<ucPeriodicTable>()
                      .FirstOrDefault();
        }
        ...
        protected void CRun(ref object tag, ref string calculus)
        {
            ...
            controls = LIMS.UserControls.OfType<ucSamples>().Where(o => !o.IsDisposed);
        ...
        protected void ButtonVisible(bool visible)
        {
            if (visible)
            {
                ...
                this.ISubS.Link(string.Empty, string.Empty);
